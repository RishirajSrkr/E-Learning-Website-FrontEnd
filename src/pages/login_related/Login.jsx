    ...
    return (
        <div className='w-full h-screen flex items-center bg-'>
            ...
            <div className='w-[350px] flex flex-col gap-3 mx-auto'>
                ...
                <button type='button' className='flex gap-2 items-center justify-center text-sm font-medium w-full py-3 rounded-full border border-lightBorder dark:border-darkBorder ' onClick={() => navigate("/login/email-password")}>
                    <MdEmail size={19} />
                    Login with Email
                </button>
